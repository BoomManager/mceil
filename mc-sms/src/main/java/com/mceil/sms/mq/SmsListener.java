package com.mceil.sms.mq;

import com.aliyuncs.exceptions.ClientException;
import com.mceil.common.utils.JsonUtils;
import com.mceil.sms.config.SmsProperties;
import com.mceil.sms.utils.SmsUtils;
...
public class SmsListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            ...
            exchange = @Exchange(name = "mc.sms.exchange",type = ExchangeTypes.TOPIC),
            key = "sms.verify.code"
    ))
